...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/admin/newMemberDetail.css" rel="stylesheet"/>
    <style>
        #logo{
        ...
        <div id="subnavigation_result">
            <div id="subnavigation_result_header">
                ...
                <div id="subnavigation_how_array">
                    ...
                    <div class="subnavigation_how">
                        ...
                        <div class="subnavigation_how_main">
                            <select class="selectnormalcolor">
                                <option>아이디오름차순</option>
                                <option>아이디내림차순</option>
            ...
            <div id="subnavigation_result_body">
                ...
                <div id="subnavigation_list">
                 <form action="${pageContext.request.contextPath}/admin/memberUpdate.admin?mbunho=${mbunho}">
                    <div id="subnavigation_list_title">
                        <!--<input type="checkbox" />-->
                        <span>멤버 번호</span>
                        <input type="text" value="${memberOne.getMemberNumber()}" name="mbunho"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>이메일</span>
                        <input type="text" value="${memberOne.getMemberEmail()}" name="memberEmail"/>
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>비밀번호</span>
                        <input type="text" value="${memberOne.getMemberPassword()}" name="memberPassword"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>닉네임</span>
                        <input type="text" value="${memberOne.getMemberNickname()}" name="memberNickname"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>프로필이미지</span>
                        <input type="text" value="${memberOne.getMemberProfileImage()}" name="memberProfileImage"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>인사말</span>
                        <input type="text" value="${memberOne.getMemberGreetings()}" name="memberGreetings"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>가입경로</span>
                        <input type="text" value="${memberOne.getMemberJoinType()}" name="memberJoinType"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>이름</span>
                        <input type="text" value="${memberOne.getMemberName()}" name="memberName"/>
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>전화번호</span>
                        <input type="text" value="${memberOne.getMemberPhoneNumber()}" name="memberPhoneNumber"/>
                    </div>
                </div>
            
                <div id="back_and_submit">
                    <button style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/memberList.admin'">목록으로</button>
