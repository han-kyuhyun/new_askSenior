...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/admin/newSpeechList.css" rel="stylesheet"/>
    <style>
        #logo{
        ...
        <div id="subnavigation_result">
            ...
            <div id="subnavigation_result_body">
                ...
                <div id="subnavigation_list">
                    ...
                    <c:choose>
                    	<c:when test="${not empty lectureList and fn:length(lectureList) > 0}">
                                          <c:forEach var="lectureOne" items="${lectureList}">
                                              <c:set var="gowhat" value="${lectureOne.getLectureNumber()}"/>
                                              
                                            <div class="subnavigation_list_detail" >
                                             <a class="subnavigation_list_detail" href="${pageContext.request.contextPath}/admin/lectureDetail.admin?lbunho=${gowhat}">
                                                <span><c:out value="${lectureOne.getLectureNumber()}"/></span>
                                                <span><c:out value="${lectureOne.getMemberNumber()}"/></span>
                                                <span><c:out value="${lectureOne.getLectureCategory()}"/></span>
                                                <span><c:out value="${lectureOne.getLecturelecturerIntroduction()}"/></span>
                                                <span><c:out value="${lectureOne.getLectureContent()}"/></span>                                                                  
                                                <span><c:out value="${lectureOne.getLectureDate()}"/></span>                                                                                                                                                                             
                                            </a> 
                                            </div> 
                    ...
                    <!-- <div class="subnavigation_list_detail">
                        ...
                        <span>다양한 알고리즘 코드들을 보면서 이해한다.</span>
                        <span>it-junior,kj,aaaaaa,bbbbbbb,ccccccc</span>
            ...
            <div id="page_action">
                ...
                <div id="page_arrow">
					...
					<c:when test="${prev}">  
						...
						<a style="width : 100px; color:black;"  href="${pageContext.request.contextPath}/admin/lectureList.admin?page=${page - 1}">&lt;</a>
                  ...
                  <c:otherwise>
                    ...
                    <a style="width : 100px; color:black;" href="${pageContext.request.contextPath}/admin/lectureList.admin?page=${page}">${page}</a> 
