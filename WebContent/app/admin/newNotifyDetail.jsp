...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/admin/newNotifyDetail.css" rel="stylesheet"/>
    <style>
        #logo{
    ...
    <div id="main_body">
        ...
        <div id="subnavigation_result">
            ...
            <div id="subnavigation_result_body">
                ...
                <form action="${pageContext.request.contextPath}/admin/noticeUpdate.admin?nbunho=${nbunho}">
	                    <div id="subnavigation_list_title">
	                        <!--<input type="checkbox" />-->
	                        <span>공지사항 번호</span>
	                        <input type="text" value="${noticeOne.getNoticeNumber()}" name="nbunho"/>
	                        
	                    </div>
	                    <div class="subnavigation_list_detail">
	                        <!--<input type="checkbox" name="select_member"/>-->
	                        <span>제목</span>
	                        <input type="text" value="${noticeOne.getNoticeTitle()}" name="noticeTitle"/>
	                    </div>
	                    <div class="subnavigation_list_detail">
	                        <!--<input type="checkbox" name="select_member"/>-->
	                        <span>카테고리</span>
	                        <input type="text" value="${noticeOne.getNoticeCategory()}" name="noticeCategory"/>
	                    </div>
	                    <div class="subnavigation_list_detail">
	                        <!--<input type="checkbox" name="select_member"/>-->
	                        <span>내용</span>
	                        <input type="text" value="${noticeOne.getNoticeContent()}" name="noticeContent"/>
	                        
	                    </div>
	                    <div class="subnavigation_list_detail">
	                        <!--<input type="checkbox" name="select_member"/>-->
	                        <span>작성 일자</span>
	                        <input type="text" value="${noticeOne.getNoticeUpdatedDate()}" name="noticeUpdatedDate"/>
	                ...
	                <div id="back_and_submit">
	                    <button style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/noticeList.admin'">목록으로</button>
	                    <!--  <button type="submit" style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/noticeUpdate.admin?nbunho=${nbunho}&noticeTitle=${noticeTitle}'">수정하기</button> -->
