...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/admin/newAnswerDetail.css" rel="stylesheet"/>
    <style>
         #logo{
                    ...
                    <div class="subnavigation_how">
                        ...
                        <div class="subnavigation_how_main">
                            <select class="selectnormalcolor">
                                ...
                                <option>답변번호 오름차순</option>
                                <option>답변번호 내림차순</option>
            ...
            <div id="subnavigation_result_body">
                ...
                <div id="subnavigation_list">
                    <div id="subnavigation_list_title">
                        <!--<input type="checkbox" />-->
                        <span>답변 번호</span>
                        <input type="text" value="${answerOne.getAnswerNumber()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>질문 번호</span>
                        <input type="text" value="${answerOne.getQuestionNumber()}"/>
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>작성자</span>
                        <input type="text" value="${answerOne.getMemberNumber()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>내용</span>
                        <input type="text" value="${answerOne.getAnswerContent()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>작성 일자</span>
                        <input type="text" value="${answerOne.getAnswerUpdatedDate()}"/>
                ...
                <div id="back_and_submit">
                    <button style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/answerList.admin'">목록으로</button>
                    <button type="submit" style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/answerRemove.admin?abunho=${answerOne.getAnswerNumber()}'">삭제하기</button>
                </div>
